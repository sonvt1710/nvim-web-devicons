return { -- this file is generated from lua/nvim-web-devicons/default/icons_by_file_extension.lua, please do not edit
  ...
  ["eex"]            = { icon = "", color = "#5C466C", cterm_color = "60",  name = "Eex"                        },
  ...
  ["ex"]             = { icon = "", color = "#5C466C", cterm_color = "60",  name = "Ex"                         },
  ["exe"]            = { icon = "", color = "#9F0500", cterm_color = "124", name = "Exe"                        },
  ["exs"]            = { icon = "", color = "#5C466C", cterm_color = "60",  name = "Exs"                        },
  ...
  ["heex"]           = { icon = "", color = "#5C466C", cterm_color = "60",  name = "Heex"                       },
  ...
  ["leex"]           = { icon = "", color = "#5C466C", cterm_color = "60",  name = "Leex"                       },
